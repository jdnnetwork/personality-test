...
const O_POOL = w("O", [
  ...
  {id:528,text:"창작 활동에 몰입한 경험이 있다.",rev:false},
  ...
  {id:535,text:"내 경험 밖의 주제에는 별로 관심이 없다.",rev:true},
  {id:536,text:"새로운 것을 시도하는 것이 피곤하게 느껴진다.",rev:true},
  {id:537,text:"이론적인 이야기는 지루하다.",rev:true},
  {id:538,text:"관습을 따르는 것이 가장 효율적이라고 생각한다.",rev:true},
  {id:539,text:"예술이나 문학에 큰 흥미를 느끼지 못한다.",rev:true},
  {id:540,text:"낯선 환경에 노출되는 것이 부담스럽다.",rev:true},
  {id:541,text:"실용적이지 않은 주제는 관심이 잘 안 간다.",rev:true},
  {id:542,text:"추상적인 개념은 이해하려고 하지 않는다.",rev:true},
  {id:543,text:"한 번 익힌 방식은 바꾸지 않는 편이다.",rev:true},
  {id:544,text:"새로운 아이디어보다 검증된 방법을 택한다.",rev:true},
  {id:545,text:"예측 가능한 상황이 가장 편안하다.",rev:true},
  {id:546,text:"낯선 음악이나 음식은 잘 시도하지 않는다.",rev:true},
  {id:547,text:"상상력은 실생활에 별 도움이 안 된다고 생각한다.",rev:true},
  {id:548,text:"새로운 문화를 배우는 데 큰 관심이 없다.",rev:true},
  {id:549,text:"정해진 틀 안에서 일하는 것이 효율적이라고 본다.",rev:true},
...
const C_POOL = w("C", [
  ...
  {id:574,text:"마감이 다가올수록 집중력이 올라간다.",rev:false},
  ...
  // 역문항 30 (기존 4 + 신규 26)
  {id:28,text:"일을 미루는 경향이 있다.",rev:true},
  {id:33,text:"충동적으로 결정을 내릴 때가 많다.",rev:true},
  {id:38,text:"가끔 중요한 것을 깜빡할 때가 있다.",rev:true},
  {id:41,text:"때로는 대충 넘어가는 것도 괜찮다고 생각한다.",rev:true},
  {id:588,text:"계획 없이 즉흥적으로 움직일 때가 많다.",rev:true},
  {id:589,text:"약속 시간에 자주 늦는 편이다.",rev:true},
  {id:590,text:"마감이 임박해서야 일을 시작한다.",rev:true},
  {id:591,text:"세부 사항을 놓치는 경우가 자주 있다.",rev:true},
  {id:592,text:"규칙을 지키는 것이 귀찮게 느껴진다.",rev:true},
  {id:593,text:"해야 할 일을 자꾸 미루게 된다.",rev:true},
  {id:594,text:"정리정돈에 신경을 쓰지 않는 편이다.",rev:true},
  {id:595,text:"하기로 한 일을 중도에 포기한 적이 많다.",rev:true},
  {id:596,text:"체계적인 방식보다 즉흥적인 방식이 편하다.",rev:true},
  {id:597,text:"메모나 기록을 잘 남기지 않는다.",rev:true},
  {id:598,text:"일을 대충 넘기는 일이 자주 있다.",rev:true},
  {id:599,text:"주어진 시간보다 오래 걸리는 경우가 많다.",rev:true},
  {id:600,text:"주의가 산만해 실수가 잦다.",rev:true},
  {id:601,text:"하기 싫은 일은 자꾸 뒤로 미룬다.",rev:true},
  {id:602,text:"목표를 세워도 금방 포기한다.",rev:true},
  {id:603,text:"업무의 우선순위를 잘 정하지 못한다.",rev:true},
  ...
  {id:609,text:"끈기가 부족하다는 말을 들어본 적이 있다.",rev:true},
  {id:610,text:"중요한 일을 순간적 판단으로 결정하는 편이다.",rev:true},
  {id:611,text:"세부 사항 체크가 귀찮다.",rev:true},
  {id:612,text:"결과물의 완성도에 크게 신경 쓰지 않을 때가 많다.",rev:true},
...
const E_POOL = w("E", [
  ...
  {id:623,text:"팀워크 중심의 활동을 선호한다.",rev:false},
...
const A_POOL = w("A", [
  ...
  {id:688,text:"다른 사람과 협력하는 과정이 즐겁다.",rev:false},
  ...
  {id:705,text:"상대가 약점을 드러내면 그걸 활용한다.",rev:true},
  {id:706,text:"양보보다 내 몫을 챙기는 편이다.",rev:true},
  {id:707,text:"타인의 감정에 무감각한 편이다.",rev:true},
  {id:708,text:"필요하면 냉정하게 관계를 끊는다.",rev:true},
  {id:709,text:"남의 문제에 관여하지 않는 편이다.",rev:true},
  {id:710,text:"동정심이 별로 없다는 말을 듣는다.",rev:true},
  ...
  {id:717,text:"상대방의 어려움에 크게 동요하지 않는다.",rev:true},
  {id:718,text:"내 의견이 관철되지 않으면 불쾌하다.",rev:true},
  {id:719,text:"남에게 지는 것을 싫어한다.",rev:true},
  {id:720,text:"타인의 부탁에 쉽게 응하지 않는다.",rev:true},
  {id:721,text:"필요할 때 남을 이용할 수도 있다고 생각한다.",rev:true},
  {id:722,text:"대화에서 상대를 제압하려는 편이다.",rev:true},
  {id:723,text:"감정적인 관계보다 계산적인 관계를 선호한다.",rev:true},
  {id:724,text:"내가 옳다고 믿는 것을 쉽게 바꾸지 않는다.",rev:true},
  {id:725,text:"칭찬이나 위로에 인색한 편이다.",rev:true},
...
const N_POOL = w("N", [
  ...
  {id:730,text:"스트레스 상황에서 오히려 차분해진다.",rev:false},
  ...
  {id:743,text:"당황스러운 상황에서도 대처 방안을 찾는다.",rev:false},
  ...
  // 역문항 30 (기존 10 + 신규 20)
  {id:90,text:"걱정이 많은 편이다.",rev:true},
  ...
  {id:102,text:"기분이 쉽게 변하는 편이다.",rev:true},
  ...
  {id:764,text:"사소한 일에도 쉽게 걱정한다.",rev:true},
  {id:765,text:"불안감이 자주 찾아온다.",rev:true},
  {id:766,text:"부정적인 생각이 반복되는 편이다.",rev:true},
  {id:767,text:"비난받으면 오래 상처가 남는다.",rev:true},
  {id:768,text:"실수 후에 자책을 오래 한다.",rev:true},
  {id:769,text:"스트레스를 받으면 몸에 증상이 나타난다.",rev:true},
  {id:770,text:"미래에 대한 불안이 크다.",rev:true},
  {id:771,text:"남들의 평가에 민감하다.",rev:true},
  {id:772,text:"감정 기복이 심한 편이다.",rev:true},
  {id:773,text:"걱정 때문에 잠을 설치는 일이 잦다.",rev:true},
  {id:774,text:"작은 지적에도 오래 신경을 쓴다.",rev:true},
  {id:775,text:"실패를 쉽게 털어내지 못한다.",rev:true},
  {id:776,text:"마음이 쉽게 흔들리는 편이다.",rev:true},
  {id:777,text:"불확실한 상황이 매우 불편하다.",rev:true},
  {id:778,text:"자존감이 낮아질 때가 많다.",rev:true},
  {id:779,text:"상황이 나쁘면 감정적으로 크게 무너진다.",rev:true},
  {id:780,text:"내 감정을 다스리는 것이 어렵다.",rev:true},
  {id:781,text:"사소한 일에도 마음이 자주 상한다.",rev:true},
...
const L_POOL = w("L", [
  ...
  {id:789,text:"처음 보는 사람들과도 팀을 꾸릴 수 있다.",rev:false},
  ...
  {id:822,text:"앞에 나서는 역할은 피한다.",rev:true},
  {id:823,text:"회의에서 의견을 내는 것이 어렵다.",rev:true},
  {id:824,text:"팀을 끌어가는 것보다 따라가는 것이 좋다.",rev:true},
  {id:825,text:"다른 사람을 설득하는 것이 서툴다.",rev:true},
  {id:826,text:"팀의 방향을 제시하는 역할은 부담스럽다.",rev:true},
  {id:827,text:"결단력이 부족하다는 말을 듣는다.",rev:true},
  {id:828,text:"내가 리더가 되는 상황이 불편하다.",rev:true},
  {id:829,text:"갈등을 중재하는 것이 어렵다.",rev:true},
  {id:830,text:"의견이 갈릴 때 결론을 내리기 어렵다.",rev:true},
  {id:831,text:"다른 사람에게 지시를 내리는 것이 어렵다.",rev:true},
  {id:832,text:"문제 해결을 다른 사람에게 맡기는 편이다.",rev:true},
  {id:833,text:"팀원들 앞에서 강하게 주장하기 어렵다.",rev:true},
  {id:834,text:"리더십은 내 역할이 아니라고 느낀다.",rev:true},
  {id:835,text:"대표로 발언하는 것이 꺼려진다.",rev:true},
  {id:836,text:"다른 사람을 설득하는 것이 힘들다.",rev:true},
  {id:837,text:"팀의 성과에 대한 책임은 지고 싶지 않다.",rev:true},
  {id:838,text:"의견을 내기보다 듣는 편이 좋다.",rev:true},
  {id:839,text:"주도적으로 이끄는 역할이 피곤하다.",rev:true},
  {id:840,text:"결정이 필요한 순간 다른 사람을 바라본다.",rev:true},
  {id:841,text:"내 판단을 확신하지 못할 때가 많다.",rev:true},
  {id:842,text:"리더가 되는 것을 피하는 편이다.",rev:true},
  {id:843,text:"결단보다 합의 기다림을 선호한다.",rev:true},
  {id:844,text:"의견 차이가 생기면 뒷전으로 빠진다.",rev:true},
...
const S_POOL = w("S", [
  ...
  {id:135,text:"압박 속에서 오히려 집중력이 높아진다.",rev:false},
  ...
  {id:851,text:"긴박한 상황에서도 냉정함을 잃지 않는다.",rev:false},
  ...
  {id:858,text:"집중을 유지할 수 있는 루틴이 있다.",rev:false},
  ...
  {id:872,text:"긴 시간 집중해야 할 때 페이스를 조절할 수 있다.",rev:false},
  ...
  // 역문항 30 (기존 2 + 신규 28)
  {id:134,text:"스트레스를 받으면 일의 효율이 크게 떨어진다.",rev:true},
  {id:136,text:"여러 마감이 겹치면 패닉에 빠질 때가 있다.",rev:true},
  {id:885,text:"마감이 다가오면 극심한 불안에 시달린다.",rev:true},
  {id:886,text:"업무가 많아지면 능률이 급격히 떨어진다.",rev:true},
  {id:887,text:"예상 밖 상황을 만나면 당황해서 얼어붙는다.",rev:true},
  {id:888,text:"여러 일이 겹치면 우왕좌왕한다.",rev:true},
  ...
  {id:895,text:"긴장된 순간에 판단력이 흐려진다.",rev:true},
  {id:896,text:"업무 스트레스가 개인 생활에 영향을 미친다.",rev:true},
  {id:897,text:"실패를 오래 곱씹는 편이다.",rev:true},
  {id:898,text:"급한 일을 만나면 멘탈이 흔들린다.",rev:true},
  {id:899,text:"스트레스 해소 방법을 잘 모른다.",rev:true},
  {id:900,text:"업무 피로가 좀처럼 풀리지 않는다.",rev:true},
  {id:901,text:"난관 앞에서 의욕이 사그라든다.",rev:true},
  ...
  {id:907,text:"마음이 불안하면 집중이 안 된다.",rev:true},
  {id:908,text:"어려운 상황에서 감정 조절이 힘들다.",rev:true},
  {id:909,text:"과부하 상태에서는 판단이 흐려진다.",rev:true},
  {id:910,text:"급변하는 상황이 스트레스를 크게 준다.",rev:true},
...
const I_POOL = w("I", [
  ...
  {id:943,text:"필요 시 협업도 스스로 주도한다.",rev:false},
  ...
  // 역문항 30 (기존 4 + 신규 26)
  {id:144,text:"누군가 시켜야 움직이는 편이다.",rev:true},
  {id:148,text:"명확한 지시가 없으면 불안하다.",rev:true},
  {id:152,text:"수동적이라는 말을 듣는 편이다.",rev:true},
  {id:156,text:"다른 사람이 해주기를 기다리는 편이다.",rev:true},
  {id:948,text:"명확한 지시가 없으면 시작하기 어렵다.",rev:true},
  {id:949,text:"누가 정해주지 않으면 방향을 잃는다.",rev:true},
  {id:950,text:"자기 주도로 진행하는 것이 부담스럽다.",rev:true},
  {id:951,text:"수동적이라는 평가를 받은 적이 있다.",rev:true},
  {id:952,text:"지시 받은 일만 하는 편이다.",rev:true},
  {id:953,text:"새로운 과제는 상사의 판단을 기다린다.",rev:true},
  {id:954,text:"스스로 기획하고 실행하는 것이 어렵다.",rev:true},
  {id:955,text:"업무 중 결정을 남에게 미루는 편이다.",rev:true},
  {id:956,text:"자기 개발은 회사가 주도해주기를 바란다.",rev:true},
  {id:957,text:"지시가 없을 때 무얼 할지 몰라 헤맨다.",rev:true},
  ...
  {id:971,text:"스스로 동기부여가 잘 안 된다.",rev:true},
  {id:972,text:"주도권을 잡는 것이 부담스럽다.",rev:true},
  {id:973,text:"자기 주도 학습이 힘들다.",rev:true},
]);
...
const F_POOL = w("F", [
  ...
  {id:988,text:"한 번 시작하면 끝까지 해낸다.",rev:false},
  ...
  {id:994,text:"세부 사항을 끝까지 확인하는 편이다.",rev:false},
  ...
  // 역문항 30 (기존 5 + 신규 25)
  {id:163,text:"쉽게 산만해지는 편이다.",rev:true},
  ...
  {id:1028,text:"몰입 상태를 유지하기 어렵다.",rev:true},
  {id:1029,text:"복잡한 과제는 중간에 포기한다.",rev:true},
  ...
  {id:1034,text:"여러 업무를 오가며 실수한다.",rev:true},
]);
