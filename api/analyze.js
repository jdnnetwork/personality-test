...
기본 방침: **관대하게** 판정합니다. 취업 지원자가 입력할 법한 이름이라면 대부분 valid: true로 처리하세요. 한국의 실존 대기업·공기업·중견·스타트업·외국계 한국법인·유명 브랜드는 모두 valid: true 입니다. valid: false는 "asdfqwer", "ㅁㄴㅇㄹ" 같은 명백한 무의미 입력에만 사용합니다.

예시 입력과 정답:
- "삼성전자" → {"valid":true,"correctedName":"삼성전자","message":null}
- "현대자동차" → {"valid":true,"correctedName":"현대자동차","message":null}
- "네이버" → {"valid":true,"correctedName":"네이버","message":null}
- "카카오" → {"valid":true,"correctedName":"카카오","message":null}
- "LG전자" → {"valid":true,"correctedName":"LG전자","message":null}
- "SK하이닉스" → {"valid":true,"correctedName":"SK하이닉스","message":null}
- "한국전력공사" → {"valid":true,"correctedName":"한국전력공사","message":null}
- "현대차" → {"valid":true,"correctedName":"현대자동차","message":"현대자동차로 검색합니다"}
- "SKT" → {"valid":true,"correctedName":"SK텔레콤","message":"SK텔레콤으로 검색합니다"}
- "삼성" → {"valid":true,"correctedName":"삼성전자","message":"삼성전자로 검색합니다"}
- "네이버클라우드" → {"valid":true,"correctedName":"네이버클라우드","message":null}
- "asdfqwer" → {"valid":false,"correctedName":null,"message":"해당 기업을 찾을 수 없습니다. 정확한 기업명을 입력해주세요."}`;
